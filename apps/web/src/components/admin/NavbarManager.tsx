...
export const DEFAULT_NAVBAR_CONFIG: NavbarConfig = {
  ...
  menuItems: [
    { id: 'm-1', label: 'Video Downloader', url: '/', icon: 'Download', target: '_self', isActive: true },
    { id: 'm-2', label: 'Audio Extractor', url: '/audio-extractor', icon: 'Music', target: '_self', isActive: true },
    { id: 'm-3', label: 'Bulk Downloader', url: '/bulk-downloader', icon: 'Users', target: '_self', isActive: true },
    { id: 'm-4', label: 'Blog', url: '/blog', target: '_self', isActive: true },
    { id: 'm-5', label: 'Android APK', url: '/android-apk', target: '_self', isActive: true },
...
const CMS_PAGE_PRESETS = [
  { label: 'Home (TikTok Video Downloader)', url: '/' },
  { label: 'Audio Extractor', url: '/audio-extractor' },
  { label: 'Bulk Downloader', url: '/bulk-downloader' },
  { label: 'Android APK', url: '/android-apk' },
