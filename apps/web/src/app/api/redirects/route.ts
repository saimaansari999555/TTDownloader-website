...
let globalRedirects: any[] = [
  {
    ...
    statusCode: 301,
    isActive: true,
    notes: 'Permanent 301 redirect for Video Downloader home page migration',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'redir-audio-canonical',
    sourcePath: '/audio',
    targetPath: '/audio-extractor',
    statusCode: 301,
    isActive: true,
    notes: 'Permanent 301 redirect for Audio Extractor canonical URL',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'redir-bulk-canonical',
    sourcePath: '/bulk',
    targetPath: '/bulk-downloader',
    statusCode: 301,
    isActive: true,
    notes: 'Permanent 301 redirect for Bulk Downloader canonical URL',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'redir-apk-canonical',
    sourcePath: '/apk',
    targetPath: '/android-apk',
    statusCode: 301,
    isActive: true,
    notes: 'Permanent 301 redirect for Android APK canonical URL',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
