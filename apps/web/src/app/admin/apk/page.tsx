      ...
      {showForm && (
        <form onSubmit={handleCreate} className="glass-panel p-6 rounded-2xl space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div><label className="block text-sm text-text-secondary mb-2">Title *</label><input required className="w-full glass-input rounded-xl py-2.5 px-4" placeholder="TikSavePro v1.0.0" value={form.title} onChange={e => setForm(p => ({ ...p, title: e.target.value }))} /></div>
