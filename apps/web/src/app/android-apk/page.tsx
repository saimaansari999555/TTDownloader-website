...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://tik-tokdownloader.xyz/android-apk',
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    description:
      'Learn about the upcoming TikSavePro Android app and use our browser-based TikTok video, audio, MP3 and bulk downloader tools on Android today.',
    url: 'https://tik-tokdownloader.xyz/android-apk',
    type: 'website',
    siteName: 'TikSavePro',
  },
  twitter: {
...
export default function AndroidApkPage() {
  return <CustomPage params={{ slug: 'android-apk' }} />;
}
